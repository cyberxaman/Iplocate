...
try:
    ...
    print(red + "<--------------->" + red)
    print(b, "[City]:", data['city'] if args.m else ip)
    print(red + "<--------------->" + red)
    print(a, "[Region]:", data['regionName'] if args.m else ip)
    print(red + "<--------------->" + red)
    print(b, "[Country]:", data['country'] if args.m else ip)
    print(red + "<--------------->" + red)
    print(a, "[Longitude]:", data['lon'] if args.m else ip)
    print(red + "<--------------->" + red)
    print(b, "[Latitude]:", data['lat'] if args.m else ip)
    print(red + "<--------------->" + red)
